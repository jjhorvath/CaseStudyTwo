...
```{r 4C, echo=TRUE}
plot(data$Age, log(data$MthlyInc)) #log transform helps clarify the plots. There appears to be a relationship between age and monthly income, however age is really just a proxy for things like experience or time at a company/in the workforce. plotting those you get a much stronger relationship. 
