...
hist(data$JobSat,main='Histogram of Job Satisfaction',xlab='Job Satisfaction',col='green')
...
hist(data$Education,main='Histogram of Education',xlab='Years of College completed',col='blue',xlim=c(1,5))
